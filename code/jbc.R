...
jbc<- function(X, Y,W, H, K=2,D=1,theoretical.str,
...
{ 
  ...
  fit <- list(BETAPM=BETAPM,GAMMAPM=GAMMAPM, VC=VC,COV=COV, APM=APM,bPM=bPM,U=U,UVPM.l=UVPM.l,THETAPM = THETAPM, ALPHAPM = ALPHAPM,EFlPM=EFlPM,ETPM=ETPM,
